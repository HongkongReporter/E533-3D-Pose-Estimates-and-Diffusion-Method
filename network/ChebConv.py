...
body_edges = torch.tensor([[0, 1], [1, 2], [2, 3], [0, 4], [4, 5], [5, 6],
[0, 7], [7, 8], [8, 9],[8, 10], [10, 11], [11, 12], [8, 13], [13, 14], [14, 15]], dtype=torch.long)


""" Row normalization """
def normalize(X):
    rowsum = np.power(np.array(X.sum(1)), -1).flatten()
...
"""From scipy sparse to torch sparse in COO """
